...
class update_phone(QDialog):
    ...
    def initUI(self):
        ...
        self.textbox4.setPlaceholderText('请输入密码')
        ...
        self.textbox4.setGeometry(125, 125, 250, 25)
        self.textbox2.setGeometry(125, 170, 170, 25)
        self.textbox3.setGeometry(125, 215, 250, 25)
        ...
        self.btn.setGeometry(305, 170, 70, 20)
    ...
    def phone_test(self):
        ...
        if account == '' and password == '':
            reply = QMessageBox.question(self, '本程序', '请输入账号或密码', QMessageBox.Yes)
            ...
            if res:
                print(1)
                # update_phone.code = ''.join(str(i) for i in R.sample(range(1, 10), 4))
                ma = dxyz(phone)
                update_phone.code = ma
                print(ma)
                # print(update_phone.code)
    ...
    def verification_code(self):
        ...
        if input_code == update_phone.code:
        # data = 'OK'
            data = update_phone1(account, password, phone, self.s)
            print(data)
            if data == 'NO':
                QMessageBox.question(self, '本程序', '账号或密码错误', QMessageBox.Yes)
                self.textbox1.clear()
                self.textbox2.clear()
                self.textbox3.clear()
                self.textbox4.clear()
                ...
                print('1')
                QMessageBox.question(self, '本程序', '修改成功', QMessageBox.Yes)
                self.signalCall()
                print('绑定成功')
            elif data == 'Fall':
                print('失败')
