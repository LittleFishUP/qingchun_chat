...
class ValidCodeImg:
    def __init__(self, width=120, height=30, code_count=4, font_size=32, point_count=20, line_count=3,
                 img_format='png'):
        '''
    ...
    def getValidCodeImg(self):
        ...
        font = ImageFont.truetype("GB2312.ttf", size=self.font_size)
